...
export function useDatabaseContext() {
  ...
  if (!context.isInitialized && !context.isLoading) {
    return {
      ...
      createWarehouseOperation: () => ({} as any),
      updateWarehouseOperation: () => ({} as any),
      refreshPutawayTasks: () => {},
      createPutawayTask: () => ({} as any),
      refreshPickTasks: () => {},
      createPickTask: () => ({} as any),
      refreshPackTasks: () => {},
      createPackTask: () => ({} as any),
      refreshShipments: () => {},
      createShipment: () => ({} as any),
      updateShipment: () => ({} as any),
      refreshCycleCounts: () => {},
      createCycleCount: () => ({} as any),
      refreshStagingAreas: () => {},
      createStagingArea: () => ({} as any),
      refreshDispatchPlans: () => {},
      createDispatchPlan: () => ({} as any),
      refreshReturns: () => {},
      createReturn: () => ({} as any),
      refreshInventoryValuations: () => {},
      createInventoryValuation: () => ({} as any),
      refreshStockAgeing: () => {},
      createStockAgeing: () => ({} as any),
      refreshWarehouseAnalytics: () => {},
      createWarehouseAnalytics: () => ({} as any),
      refreshWarehouseAlerts: () => {},
      createWarehouseAlert: () => ({} as any),
    }
  }
