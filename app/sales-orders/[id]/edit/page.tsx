...
export default function EditSalesOrderPage({ params }: SalesOrderEditPageProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault()
    // Here you would typically save the updated sales order to your backend
    console.log("Updated Sales Order Data:", {
      id: order.id,
      ...formData,
      items,
      subtotal,
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={(
                      value: "Draft" | "Confirmed" | "In Production" | "Shipped" | "Delivered" | "Cancelled",
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => setFormData((prev) => ({ ...prev, confirmedDeliveryDate: e.target.value }))}
                  />
                </div>
              </div>
          ...
          <div className="flex justify-end gap-4">
            <Button type="button" variant="outline" asChild>
              <Link href={`/sales-orders/${order.id}`}>Cancel</Link>
            </Button>
            <Button type="submit">
