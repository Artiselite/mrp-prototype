...
import { ProcessStepTemplate, getProcessStepTemplates } from "@/lib/templates"
...
export default function ProcessStepTemplatesPage() {
  ...
  const loadTemplates = () => {
    ...
    const mockTemplates: ProcessStepTemplate[] = getProcessStepTemplates()
    setTemplates(mockTemplates)
  }

  const categories = ["all", "Steel Fabrication", "Rush Orders", "Quality Focus", "Assembly", "Electrical Components", "Custom"]
